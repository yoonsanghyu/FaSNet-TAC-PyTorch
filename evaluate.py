...
parser.add_argument('--N', default=512, type=int, help='Number of filters in autoencoder')
parser.add_argument('--L', default=32, type=int, help='Length of the filters in samples (40=5ms at 8kHZ)')
parser.add_argument('--B', default=128, type=int, help='Number of channels in bottleneck 1 × 1-conv block')
parser.add_argument('--H', default=512, type=int, help='Number of channels in convolutional blocks')
parser.add_argument('--Sc', default=128, type=int, help="Number of channels in skip-connection paths' 1 x 1-conv blocks")
parser.add_argument('--P', default=3, type=int, help='Kernel size in convolutional blocks')
parser.add_argument('--X', default=8, type=int, help='Number of convolutional blocks in each repeat')
parser.add_argument('--R', default=3, type=int, help='Number of repeats')
parser.add_argument('--C', default=2, type=int, help='Maximum number of speakers')
parser.add_argument('--causal', type=int, default=0, help='Causal (1) or noncausal(0) training')
parser.add_argument('--spatial_dim', default=33, type=int, help='spatial feature dimension')
parser.add_argument('--nmic', default=6, type=int, help='number of microphone')
...
def evaluate(args):
    ...
    with torch.no_grad():
        for i, (data) in enumerate(data_loader):
            ...
            mixture_ref = torch.chunk(padded_mixture, args.nmic, dim =1)[0] #[M, ch, T] -> [M, 1, T]
